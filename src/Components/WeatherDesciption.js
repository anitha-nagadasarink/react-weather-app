...
const WeatherDesciption = ({ weatherData }) => {
  return (
    <section>
      <div className="flex flex-col sm:flex-row justify-start my-8 ">
        <div className="flex border-b-2 mb-5 lg:border-r-2 lg:border-b-0 pr-5 lg:pr-8 mr-5 lg:mr-8">
        ...
        <div className="flex basis-1 sm:basis-1/2  flex-wrap">
          ...
          <div className="w-1/2 sm:w-1/3 mb-4">
